...
//---- MLD ------------------------------------------------------------------------------------------
	...
	// wa¿na jest kolejnoœæ switcha a nie funkcji powy¿ej w wyœwietlaniu s³ów - gdyby pierwszym switczem
	// by³a jednostka (jed) to wtedy jako pierwsze s³owo pojawi³aby siê jednostka a nie setka.
	switch ( set )
	{
		case 0:
			break;
